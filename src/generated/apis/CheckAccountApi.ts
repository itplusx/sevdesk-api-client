...
import {
    ...
    ModelCheckAccountFromJSON,
    ModelCheckAccountToJSON,
...
export interface CreateCheckAccountRequest {
    modelCheckAccount?: Omit<ModelCheckAccount, 'id'|'objectName'|'create'|'update'|'bankServer'>;
}
...
export class CheckAccountApi extends runtime.BaseAPI {
     ...
     * @deprecated
     */
    async createCheckAccountRaw(requestParameters: CreateCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetCheckAccounts200Response>> {
        ...
        const response = await this.request({
            ...
            body: ModelCheckAccountToJSON(requestParameters['modelCheckAccount']),
        }, initOverrides);
     ...
     * @deprecated
     */
    async createCheckAccount(requestParameters: CreateCheckAccountRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetCheckAccounts200Response> {
        const response = await this.createCheckAccountRaw(requestParameters, initOverrides);
    ...
    async deleteCheckAccountRaw(requestParameters: DeleteCheckAccountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeleteCheckAccount200Response>> {
        ...
        const response = await this.request({
            path: `/CheckAccount/{checkAccountId}`.replace(`{${"checkAccountId"}}`, encodeURIComponent(String(requestParameters['checkAccountId']))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getBalanceAtDateRaw(requestParameters: GetBalanceAtDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetBalanceAtDate200Response>> {
        ...
        const response = await this.request({
            path: `/CheckAccount/{checkAccountId}/getBalanceAtDate`.replace(`{${"checkAccountId"}}`, encodeURIComponent(String(requestParameters['checkAccountId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
