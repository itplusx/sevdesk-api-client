...
export interface ExportDatevRequest {
    startDate: number;
    endDate: number;
    scope: string;
    download?: boolean;
...
export class ExportApi extends runtime.BaseAPI {
     ...
     * Export datev
     */
    async exportDatevRaw(requestParameters: ExportDatevRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<object>> {
        if (requestParameters['startDate'] == null) {
            throw new runtime.RequiredError(
                'startDate',
                'Required parameter "startDate" was null or undefined when calling exportDatev().'
            );
        }
        ...
        if (requestParameters['endDate'] == null) {
            throw new runtime.RequiredError(
                'endDate',
                'Required parameter "endDate" was null or undefined when calling exportDatev().'
            );
        }
        ...
        if (requestParameters['scope'] == null) {
            throw new runtime.RequiredError(
                'scope',
                'Required parameter "scope" was null or undefined when calling exportDatev().'
            );
        }
     ...
     * Export datev
     */
    async exportDatev(requestParameters: ExportDatevRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.exportDatevRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async updateExportConfigRaw(requestParameters: UpdateExportConfigOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CheckAccountTransactionEnshrine200Response>> {
        ...
        const response = await this.request({
            path: `/SevClient/{SevClientId}/updateExportConfig`.replace(`{${"SevClientId"}}`, encodeURIComponent(String(requestParameters['sevClientId']))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
