...
export interface SendorderViaEMailRequest {
    orderId: number;
...
export class OrderApi extends runtime.BaseAPI {
    ...
    async getDiscountsRaw(requestParameters: GetDiscountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetDiscounts200Response>> {
        ...
        const response = await this.request({
            path: `/Order/{orderId}/getDiscounts`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getOrderPositionsByIdRaw(requestParameters: GetOrderPositionsByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        ...
        const response = await this.request({
            path: `/Order/{orderId}/getPositions`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getRelatedObjectsRaw(requestParameters: GetRelatedObjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetOrderPositionsById200Response>> {
        ...
        const response = await this.request({
            path: `/Order/{orderId}/getRelatedObjects`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async orderGetPdfRaw(requestParameters: OrderGetPdfRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<OrderGetPdf200Response>> {
        ...
        const response = await this.request({
            path: `/Order/{orderId}/getPdf`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async orderSendByRaw(requestParameters: OrderSendByOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ModelOrderResponse>> {
        ...
        const response = await this.request({
            path: `/Order/{orderId}/sendBy`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
     ...
     */
    async sendorderViaEMailRaw(requestParameters: SendorderViaEMailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SendorderViaEMail201Response>> {
        if (requestParameters['orderId'] == null) {
            throw new runtime.RequiredError(
                'orderId',
        ...
        const response = await this.request({
            path: `/Order/{orderId}/sendViaEmail`.replace(`{${"orderId"}}`, encodeURIComponent(String(requestParameters['orderId']))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Send order via email
     */
    async sendorderViaEMail(requestParameters: SendorderViaEMailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SendorderViaEMail201Response> {
