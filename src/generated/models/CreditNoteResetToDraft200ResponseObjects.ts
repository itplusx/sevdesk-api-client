...
export function CreditNoteResetToDraft200ResponseObjectsToJSON(value?: Omit<CreditNoteResetToDraft200ResponseObjects, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null): any {
    if (value == null) {
        return value;
    }
    return {
