...
import type { ModelCheckAccountSevClient } from './ModelCheckAccountSevClient';
import {
    ModelCheckAccountSevClientFromJSON,
    ModelCheckAccountSevClientFromJSONTyped,
    ModelCheckAccountSevClientToJSON,
} from './ModelCheckAccountSevClient';
...
export interface ModelCheckAccount {
    ...
    /**
     * 
     * @type {ModelCheckAccountSevClient}
     * @memberof ModelCheckAccount
     */
    sevClient?: ModelCheckAccountSevClient;
    /**
     ...
     * @memberof ModelCheckAccount
     */
    type: ModelCheckAccountTypeEnum;
    /**
     * Import type. Transactions can be imported by this method on the check account.
     * @type {string}
     * @memberof ModelCheckAccount
     */
    importType?: ModelCheckAccountImportTypeEnum | null;
    /**
     ...
     * @memberof ModelCheckAccount
     */
    defaultAccount?: ModelCheckAccountDefaultAccountEnum;
    /**
     * Status of the check account. 0 <-> Archived - 100 <-> Active
     * @type {number}
     * @memberof ModelCheckAccount
     */
    status: ModelCheckAccountStatusEnum;
    /**
 ...
 * @export
 */
export const ModelCheckAccountTypeEnum = {
    Online: 'online',
    Offline: 'offline'
} as const;
export type ModelCheckAccountTypeEnum = typeof ModelCheckAccountTypeEnum[keyof typeof ModelCheckAccountTypeEnum];

/**
 * @export
 */
export const ModelCheckAccountImportTypeEnum = {
    Csv: 'CSV',
    Mt940: 'MT940',
    Null: 'null'
} as const;
export type ModelCheckAccountImportTypeEnum = typeof ModelCheckAccountImportTypeEnum[keyof typeof ModelCheckAccountImportTypeEnum];

/**
 * @export
 */
export const ModelCheckAccountDefaultAccountEnum = {
    NUMBER_0: 0,
    NUMBER_1: 1
} as const;
export type ModelCheckAccountDefaultAccountEnum = typeof ModelCheckAccountDefaultAccountEnum[keyof typeof ModelCheckAccountDefaultAccountEnum];

/**
 * @export
 */
export const ModelCheckAccountStatusEnum = {
    NUMBER_0: 0,
    NUMBER_100: 100
} as const;
export type ModelCheckAccountStatusEnum = typeof ModelCheckAccountStatusEnum[keyof typeof ModelCheckAccountStatusEnum];


/**
 * Check if a given object implements the ModelCheckAccount interface.
 */
export function instanceOfModelCheckAccount(value: object): value is ModelCheckAccount {
...
export function ModelCheckAccountFromJSON(json: any): ModelCheckAccount {
    return ModelCheckAccountFromJSONTyped(json, false);
}

export function ModelCheckAccountFromJSONTyped(json: any, ignoreDiscriminator: boolean): ModelCheckAccount {
    if (json == null) {
        return json;
    }
    return {
        ...
        'sevClient': json['sevClient'] == null ? undefined : ModelCheckAccountSevClientFromJSON(json['sevClient']),
        'name': json['name'],
        'type': json['type'],
...
export function ModelCheckAccountToJSON(value?: Omit<ModelCheckAccount, 'id'|'objectName'|'create'|'update'|'bankServer'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        
        'sevClient': ModelCheckAccountSevClientToJSON(value['sevClient']),
        'name': value['name'],
        'type': value['type'],
