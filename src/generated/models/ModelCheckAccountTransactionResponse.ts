...
export interface ModelCheckAccountTransactionResponse {
    ...
    /**
     * Can only be set via [CheckAccountTransaction/{checkAccountTransactionId}/enshrine](#tag/CheckAccountTransaction/operation/checkAccountTransactionEnshrine)
     * 
     * @type {Date}
     * @memberof ModelCheckAccountTransactionResponse
     */
...
export function ModelCheckAccountTransactionResponseToJSON(value?: Omit<ModelCheckAccountTransactionResponse, 'id'|'objectName'|'create'|'update'|'status'|'enshrined'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'entryDate': value['entryDate'] == null ? undefined : ((value['entryDate'] as any).toISOString()),
