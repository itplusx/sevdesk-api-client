...
export function ModelCreditNoteToJSON(value?: Omit<ModelCreditNote, 'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null): any {
    if (value == null) {
        return value;
    }
    return {
