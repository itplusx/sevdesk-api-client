...
export function ModelCreditNoteUpdateToJSON(value?: Omit<ModelCreditNoteUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null): any {
    if (value == null) {
        return value;
    }
    return {
