...
export function ModelInvoicePosToJSON(value?: Omit<ModelInvoicePos, 'create'|'update'|'sumDiscount'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'priceNet'> | null): any {
    if (value == null) {
        return value;
    }
    return {
