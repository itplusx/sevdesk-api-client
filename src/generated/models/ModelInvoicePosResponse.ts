...
export function ModelInvoicePosResponseToJSON(value?: Omit<ModelInvoicePosResponse, 'id'|'objectName'|'create'|'update'|'quantity'|'price'|'name'|'positionNumber'|'text'|'discount'|'taxRate'|'sumDiscount'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'priceNet'|'priceGross'|'priceTax'> | null): any {
    if (value == null) {
        return value;
    }
    return {
