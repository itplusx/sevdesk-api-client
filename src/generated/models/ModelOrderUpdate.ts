...
export function ModelOrderUpdateToJSON(value?: Omit<ModelOrderUpdate, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumDiscounts'|'sumNetForeignCurrency'|'sumTaxForeignCurrency'|'sumGrossForeignCurrency'|'sumDiscountsForeignCurrency'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'orderDate': value['orderDate'] == null ? undefined : ((value['orderDate'] as any).toISOString()),
        'status': value['status'],
        'header': value['header'],
