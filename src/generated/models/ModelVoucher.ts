...
export function ModelVoucherToJSON(value?: Omit<ModelVoucher, 'id'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'recurringInterval'|'recurringStartDate'|'recurringNextVoucher'|'recurringLastVoucher'|'recurringEndDate'|'enshrined'> | null): any {
    if (value == null) {
        return value;
    }
    return {
