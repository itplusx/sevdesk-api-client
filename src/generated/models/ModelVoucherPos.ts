...
export function ModelVoucherPosToJSON(value?: Omit<ModelVoucherPos, 'id'|'create'|'update'|'sumTax'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'> | null): any {
    if (value == null) {
        return value;
    }
    return {
