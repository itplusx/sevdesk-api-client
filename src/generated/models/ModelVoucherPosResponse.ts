...
export function ModelVoucherPosResponseToJSON(value?: Omit<ModelVoucherPosResponse, 'id'|'objectName'|'create'|'update'|'sumTax'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'> | null): any {
    if (value == null) {
        return value;
    }
    return {
