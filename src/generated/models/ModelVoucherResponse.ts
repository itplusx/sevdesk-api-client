...
export function ModelVoucherResponseToJSON(value?: Omit<ModelVoucherResponse, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'enshrined'> | null): any {
    if (value == null) {
        return value;
    }
    return {
