...
export function VoucherResetToOpen200ResponseObjectsToJSON(value?: Omit<VoucherResetToOpen200ResponseObjects, 'id'|'objectName'|'create'|'update'|'sumNet'|'sumTax'|'sumGross'|'sumNetAccounting'|'sumTaxAccounting'|'sumGrossAccounting'|'sumDiscounts'|'sumDiscountsForeignCurrency'|'paidAmount'|'enshrined'> | null): any {
    if (value == null) {
        return value;
    }
    return {
        ...
        'voucherDate': value['voucherDate'] == null ? undefined : ((value['voucherDate'] as any).toISOString()),
        ...
        'propertyForeignCurrencyDeadline': value['propertyForeignCurrencyDeadline'] == null ? undefined : ((value['propertyForeignCurrencyDeadline'] as any).toISOString()),
        'propertyExchangeRate': value['propertyExchangeRate'],
        'recurringInterval': value['recurringInterval'],
        'recurringStartDate': value['recurringStartDate'] == null ? undefined : ((value['recurringStartDate'] as any).toISOString()),
        'recurringNextVoucher': value['recurringNextVoucher'] == null ? undefined : ((value['recurringNextVoucher'] as any).toISOString()),
        'recurringLastVoucher': value['recurringLastVoucher'] == null ? undefined : ((value['recurringLastVoucher'] as any).toISOString()),
        'recurringEndDate': value['recurringEndDate'] == null ? undefined : ((value['recurringEndDate'] as any).toISOString()),
        'taxSet': ModelVoucherResponseTaxSetToJSON(value['taxSet']),
        'paymentDeadline': value['paymentDeadline'] == null ? undefined : ((value['paymentDeadline'] as any).toISOString()),
        'deliveryDate': value['deliveryDate'] == null ? undefined : ((value['deliveryDate']).toISOString()),
        'deliveryDateUntil': value['deliveryDateUntil'] == null ? undefined : ((value['deliveryDateUntil'] as any).toISOString()),
    };
}
